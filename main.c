...
void PulseGenerator( void )
{
    ...
    {     
        ...
        if( gGenMode==FALSE )
        {  
            if(gShotWaitTime<=800)  //0.5ms * 800 = 400ms
            {
                 gShotWaitTime++;
            }          
            else
        ...
        {     
          ...
          if(gShotWaitTime<=400)  //0.5ms * 400 = 200ms
            {
                 gShotWaitTime++;   
                 gShotGapWaitTime = 0;
            }          
                ...
                {   
                   if( gCurState == 0 )
                    ...
                    {              
                        ...
                        gElLoc++;   
                        gCurState = 0;  
                        gShotGapWaitTime = 200;  //0.5ms * 200 = 100ms             
                        if( gElLoc > 3 )
                        {  
                            gShotCnt++;                   
                            gElLoc = 0; 
...
void main()
{
   ...
   while ( TRUE )
   {
      ...
      {           
        ...
        //yjw add 2021.04.03
        //set volatge2               
        if(!gSetVolagteInitTime &&  gRunFlag==FALSE)
        { 
            if( IN_FET_SEN )
            {                   
                PORTC = 0x00; 
